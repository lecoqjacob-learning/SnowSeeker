...
struct SortAndFilterView: View {
    ...
    @EnvironmentObject var resortFilters: ResortFilters
...
//                                        selections: resortFilters.filters[0].selections,
                                        convertValue: { $0 },
...
//        update(selections: &countriesSelection, selection: country)
        update(selections: &resortFilters.filters[0].selections, selection: country)
    }
